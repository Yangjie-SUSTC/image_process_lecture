...
\section{\textbf{Fingerprint sharpen}}\ \ \ \ \ \
...
\fref{fig:fingerprint2} is the sharpen image of fingerprint 2 image with different image and cut off frequency. It is clear to see that only when $D_0\leq0.3$, the result is acceptabl
\vspace{0.5cm}
\begin{longtable}{rccc}
...
\setlength{\belowcaptionskip}{-2cm}
  ...
  \\
  \\
  0.9& \includegraphics[width=4 cm]{matlab2/fingerprint2_HPFI_sharp_9.jpg} &\includegraphics[width=4 
  cm]{matlab2/fingerprint2_HPFB_sharp_9.jpg} & \includegraphics[width=4cm]{matlab2/fingerprint2_HPFB_sharp_9.jpg} \\
\end{longtable}
