...
\centering
\subfigure[original]{
\includegraphics[width=4 cm]{python/cameraWithNoise_original.jpg}}
\subfigure[Noise]{
\includegraphics[width=4 cm]{python/cameraWithNoise_noise.jpg}}
\subfigure[Denoise]{
\includegraphics[width=4 cm]{python/cameraWithNoise_denoise.jpg}}
\subfigure[Histogram]{
\includegraphics[height=4 cm,width=8cm]{python/cameraWithNoise_hist}}
\caption{Images of camera with noise}
\label{fig:camera}
\end{figure}
...
\centering
\subfigure[original]{
\includegraphics[height=4 cm]{python/LenaWithNoise_original.jpg}}
\subfigure[FFT]{
\includegraphics[height=4 cm,]{python/LenaWithNoise_fft_log}}
\subfigure[Filter]{
\includegraphics[height=4 cm]{python/LenaWithNoise_mask_70.jpg}}
\subfigure[Filtered FFT]{
\includegraphics[height=4 cm]{python/LenaWithNoise_mask_sft.jpg}}
\subfigure[Noise]{
\includegraphics[height=4 cm]{python/LenaWithNoise_noise.jpg}}
\subfigure[Denoise]{
\includegraphics[height=4 cm]{python/LenaWithNoise_denoise.jpg}}
\subfigure[Histogram]{
\includegraphics[height=4 cm,width=8cm]{python/LenaWithNoise_hist}}


\caption{Images of Lena with noise}
\label{fig:lena}
\end{figure}
...
%\setlength{\belowcaptionskip}{-2cm}
  % after \\: \hline or \cline{col1-col2} \cline{col3-col4} ...
   filter & lenaD1& lenaD2 & lenaD3\\
    \rotatebox{90}{Original} & \includegraphics[width=4 cm]{python/lenaD1_original.jpg} &\includegraphics[width=4 cm]{python/lenaD2_original.jpg} & \includegraphics[width=4 cm]{python/lenaD3_original.jpg} \\
     \rotatebox{90}{Histogram} & \includegraphics[width=4 cm]{python/lenaD1_hist.jpg} &\includegraphics[width=4 cm]{python/lenaD2_hist.jpg} & \includegraphics[width=4 cm]{python/lenaD3_hist.jpg} \\

  \rotatebox{90}{Arithmetic mean} & \includegraphics[width=4 cm]{python/lenaD1_amf.jpg} &\includegraphics[width=4 cm]{python/lenaD2_amf.jpg} & \includegraphics[width=4 cm]{python/lenaD3_amf.jpg} \\
  \rotatebox{90}{Geometric mean} & \includegraphics[width=4 cm]{python/lenaD1_gmf.jpg} &\includegraphics[width=4 cm]{python/lenaD2_gmf.jpg} & \includegraphics[width=4 cm]{python/lenaD3_gmf.jpg} \\
  \rotatebox{90}{Median} & \includegraphics[width=4 cm]{python/lenaD1_median.jpg} &\includegraphics[width=4 cm]{python/lenaD2_median.jpg} & \includegraphics[width=4 cm]{python/lenaD3_median.jpg}
  \\
  \vspace{0.1cm}\\
  \vspace{-2cm}\\
  \rotatebox{90}{Alpha-trimmed mean} & \includegraphics[width=4 cm]{python/lenaD1_atmf.jpg} &\includegraphics[width=4 cm]{python/lenaD2_atmf.jpg} & \includegraphics[width=4 cm]{python/lenaD3_atmf.jpg}
  \\
  \rotatebox{90}{Adaptive mean} & \includegraphics[width=4 cm]{python/lenaD1_admf.jpg} &\includegraphics[width=4 cm]{python/lenaD2_admf.jpg} & \includegraphics[width=4 cm]{python/lenaD3_admf.jpg}
  \\
\end{longtable}
...
\caption{Denoised Lena by different filters with $ k_{size}=5$ }
\label{fig:denoise}
\end{figure}
