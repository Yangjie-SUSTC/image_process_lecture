...
It is clear to see that high pass filter can extract edges in image. For IHPF, there are artifacts image. BHPFcan attenuate the artifacts and GHPF has no artifacts. The GHPF has best performance in edge extraction of all three images. \fref{fig:HP}
